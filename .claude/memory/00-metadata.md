# ALPHA MEDICAL - PROJECT METADATA

> **Level 1 Memory - ALWAYS LOADED (Core Identity)**
...
**What We Are:** B2C RETAILER (PAS B2B, PAS D2C fabricant direct!)
**What We Sell:** Medical equipment (knee braces, posture correctors, therapy devices)
**Target Market:** US consumers with pain relief needs
**Customer Personas:** Seniors, office workers, athletes
**Revenue Model:** Dropshipping (DSers/AliExpress) + Future subscriptions

**Critical Distinction:**
- ✅ B2C RETAILER = We sell TO consumers (retailer)
- ❌ NOT D2C = We are NOT the manufacturer selling direct
- ❌ NOT B2B = We do NOT sell to other businesses
...
**Branch:** main
**Working Directory:** /Users/mac/Desktop/Alpha-Medical
